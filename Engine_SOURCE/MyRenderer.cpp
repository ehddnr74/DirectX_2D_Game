...
namespace renderer
{
	...
	//
	My::Camera* mainCamera = nullptr;
	std::vector<My::Camera*> cameras = {};
...
#pragma region InputLayout
		...
		shader = My::Resources::Find<Shader>(L"GridShader");
		My::graphics::GetDevice()->CreateInputLayout(arrLayout, 3
			, shader->GetVSCode()
			, shader->GetInputLayoutAddressOf());

		shader = My::Resources::Find<Shader>(L"DebugShader");
		My::graphics::GetDevice()->CreateInputLayout(arrLayout, 3
			, shader->GetVSCode()
			, shader->GetInputLayoutAddressOf());
...
#pragma endregion
	...
	void LoadShader()
	{
		...
		My::Resources::Insert(L"GridShader", girdShader);
		...
		My::Resources::Insert(L"DebugShader", debugShader);
	}
